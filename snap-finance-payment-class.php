...
class WC_snap_finance_Gateway extends WC_Payment_Gateway {
	 ...
	 * @var bool
	 */
	public $snap_finance_mode; // Snap payment mode
	public $snap_finance_client_id; // Snap Client Id
	public $snap_finance_client_secret; // Snap Client Secret
	public $snap_finance_checkout_button; // Snap checkout button
	public $snap_finance_checkout_option;
	public $snap_finance_api_url; // Snap api url
	public $snap_finance_api_audience_url; // Snap api banner url
	public $snap_finance_token; // Snap token
	...
	public function __construct() {
		...
		$this->method_description = 'Credit-challenged? Snap approves $300 up to $5,000 in accessible lease-to-own financing.'; // will be displayed on the options page
	...
	public function init_form_fields() {
		...
		$this->form_fields = array(
			...
			'description'                                 => array(
				...
				'default'     => 'Credit-challenged? Snap approves $300 up to $5,000 in accessible lease-to-own financing.',
			),
			'snap_finance_mode'                           => array(
				'title'       => __( 'Environment', 'snap-finance-checkout' ),
				'type'        => 'select',
				'options'     => array(
					'sandbox' => __( 'Sandbox', 'snap-finance-checkout' ),
					'live'    => __( 'Production', 'snap-finance-checkout' ),
				),
				'description' => '',
				'default'     => 'sandbox',
			),
